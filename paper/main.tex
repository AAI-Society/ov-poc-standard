...
Publishing one root costs \SI{85.8}{\micro\second}---one signature and an
append. Our gateway sustains about 5{,}085 actions per second on one core.
...
Batching 128 actions under one signature makes each action \textbf{61 times
cheaper}---from \SI{85.5}{\micro\second} to \SI{1.4}{\micro\second}, and from
11{,}690 to 707{,}380 actions per second on one core. The price is that an
action is not covered by a signature until its batch closes, which at that size
is at most \SI{180}{\micro\second}.
