...
like the EU AI Act — or a state law or agency rule — be enforced against evidence rather than
trusted on a filing, which is why the people shaping those rules have a direct stake in the
evidence layer this standard defines.
...
> **✍️ [DRAFT]** — the article-level crosswalk (which AI Act obligations each Proof-of-Control
> domain and evidence property supports) is working-group work in progress.
