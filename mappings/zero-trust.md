...
**Coverage: 44%** of the 118 Proof-of-Control requirements (8 exact matches, 44 partial matches, 66 not covered), computed per the [mapping rubric](rubric.md) from the row-level [coding sheet](coding_sheet.csv). *Draft seed coding — pending working-group validation.* To change this table, edit the coding sheet and run `python3 tools/generate_crosswalks.py`.
...
| --- | :---: | :---: | --- | --- |
| [C1.1 Model and Artifact Provenance](../0.1/en/0x10-C01-Provenance.md) | 5 | None | — | Artifact provenance outside ZTA scope |
...
| [C2.1 Data-Access Evidence](../0.1/en/0x10-C02-Privacy.md) | 3 | Partial | PEP logging (§3) | Policy enforcement point logging records resource access; no evidence-content model |
| [C2.2 Policy and Consent Enforcement](../0.1/en/0x10-C02-Privacy.md) | 5 | Partial | Policy Engine (§3) | Policy engine evaluates per-request context including data policies |
| [C2.3 Privacy-Preserving Verification Mechanisms](../0.1/en/0x10-C02-Privacy.md) | 3 | None | — | Not addressed |
| [C2.4 Evidence Handling for Protected Data](../0.1/en/0x10-C02-Privacy.md) | 2 | None | — | Not addressed |
| [C3.1 Boundary-Crossing Evidence](../0.1/en/0x10-C03-Portability.md) | 2 | Partial | Tenets 2–3 (§2.1) | No implicit trust across boundaries; every crossing is re-evaluated, though not evidenced for third parties |
| [C3.2 Cross-Environment Continuity](../0.1/en/0x10-C03-Portability.md) | 3 | None | — | Evidence continuity not addressed |
| [C4.1 Authority and Scope Enforcement](../0.1/en/0x10-C04-Authorization.md) | 8 | Exact | Tenets 3, 4, 6; PEP (§3) | Per-request access evaluation at the PEP with least privilege matches authority-and-scope enforcement |
| [C4.2 Delegation](../0.1/en/0x10-C04-Authorization.md) | 4 | Partial | Tenet 4 | Dynamic authorization covers authority scoping; delegation chains not addressed |
| [C5.1 Agent and Principal Binding](../0.1/en/0x10-C05-Identity.md) | 4 | Partial | Tenet 6 | Strong authentication of all subjects and devices; principal-to-agent intent binding not addressed |
| [C5.2 Inter-Agent Identity](../0.1/en/0x10-C05-Identity.md) | 2 | Partial | Tenet 2 | Mutual authentication between services covers inter-agent message authenticity |
...
| [C6.3 Cryptographic Key Lifecycle](../0.1/en/0x10-C06-Security.md) | 5 | None | — | Key lifecycle not addressed at this level |
...
| [C10.3 Continuously Monitored Operation](../0.1/en/0x10-C10-Conformance-and-Disclosure.md) | 7 | Partial | Tenet 7; CDM integration | Continuous diagnostics and mitigation align with continuous-operation intent |
